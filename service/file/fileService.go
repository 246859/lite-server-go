...
import (
	...
	"github.com/246859/lite-server-go/model/file"
...
// @Return error
// @Description: 上传文件
func (f FileService) SaveUploadMultiFile(fileHeaders []*multipart.FileHeader, ctx *gin.Context) ([]file.FileInfo, error) {
	// 创建文件信息切片
...
func SaveUploadSingle(fileHeader *multipart.FileHeader, ctx *gin.Context) (file.FileInfo, error) {
